...
class DisplayPopAdd:
    ...
    def displayPop(self):
        ...
        formWindow.title("Form Add Biaya")
        ...
        judulLabel = ttk.Label(formWindow, text="[Add Biaya]", font=("Poppins", 16, "bold"))  # Changed font to Poppins
        judulLabel.grid(row=1, column=0, columnspan=2, pady=20, padx=(0, 300))  # Add padding to left and right (move right)
        ...
        imgIya = Image.open("img/addButton.png")  # Replace with your image path for the "Save" button
