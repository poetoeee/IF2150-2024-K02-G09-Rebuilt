...
class ProjectUI:
    def __init__(self, root):
        ...
        self.root.configure(bg="#FFFFFF")  # Latar belakang putih untuk root
    ...
    def create_tugas_frame(self):
        ...
        tugas_frame = ctk.CTkFrame(self.root, corner_radius=10, fg_color="#FFFFFF")  # Latar putih
    ...
    def create_biaya_section(self):
        ...
        biaya_frame = ctk.CTkFrame(self.root, corner_radius=10, fg_color="#FFFFFF")  # Latar putih
        ...
        left_frame = ctk.CTkFrame(biaya_frame, corner_radius=10, fg_color="#FFFFFF")  # Latar putih
        ...
        top_right_frame = ctk.CTkFrame(biaya_frame, corner_radius=10, fg_color="#FFFFFF")  # Latar putih
        ...
        bottom_right_frame = ctk.CTkFrame(biaya_frame, corner_radius=10, fg_color="#FFFFFF")  # Latar putih
        ...
        add_btn = ctk.CTkButton(
            ...
            fg_color="#4682B4",  # Tombol biru baja
            text_color="#FFFFFF"  # Teks tombol putih
        )
    ...
    def create_scrollable_table(self, parent):
        ...
        outer_frame = ctk.CTkFrame(parent, fg_color="#FFFFFF")  # Latar putih
        outer_frame.pack(fill="both", expand=True)

        # Canvas untuk scrolling
        canvas = tk.Canvas(outer_frame, bg="#FFFFFF")  # Latar putih
        canvas.pack(side="left", fill="both", expand=True)

        # Scrollbars
        v_scrollbar = ctk.CTkScrollbar(outer_frame, command=canvas.yview, fg_color="#4682B4")  # Scrollbar biru baja
        ...
        scrollable_frame = ctk.CTkFrame(canvas, fg_color="#FFFFFF")  # Latar putih
        ...
        for row_idx, biaya in enumerate(biaya_list, start=1):
            ...
            # Action Buttons
            action_frame = ctk.CTkFrame(scrollable_frame, corner_radius=5, fg_color="#FFFFFF")  # Latar putih
            ...
            ctk.CTkButton(
                ...
                text="✏",
                width=30,
                fg_color="#4B0082",  # Tombol ungu gelap
                text_color="#FFFFFF",  # Teks tombol putih
